...
/* When print in the inverted sequence, the head node will be print out. 
   No need to debug it, the purpose of printing the link in inverted sequence, 
   is that just seeing the double link is correct or not*/
